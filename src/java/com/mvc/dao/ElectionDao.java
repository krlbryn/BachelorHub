...
public class ElectionDao {
    ...
    public List<ElectionBean> getAllElections() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                // Mapped to the specific column in your database
                election.setElectionImage(resultSet.getString("election_Image"));
    ...
    public List<ElectionBean> getActiveElections() {
        ...
        try {
            con = DBConnection.createConnection();
            statement = con.createStatement();
            // Matching the 'Active' string used in your data
