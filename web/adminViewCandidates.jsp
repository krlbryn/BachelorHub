            ...
            <tbody>
                <%
                    try {
                        ...
                        String sql = "SELECT c.cand_ID, c.cand_ManifestoDesc, c.cand_PhotoPath, s.stu_Name, s.stud_ID, p.position_Name FROM candidate c JOIN student s ON c.stud_ID = s.stud_ID JOIN position p ON c.position_ID = p.position_ID WHERE p.election_ID = ? ORDER BY p.position_Name";
                ...
                <tr>
                    ...
                    <td><span class="status active" style="background:#e2e6ea; color:#333;"><%= rs.getString("position_Name") %></span></td>
