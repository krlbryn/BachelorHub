            ...
            <div class="content-wrapper" id="candidateList">
                <%
                    try {
                        ...
                        // FIXED QUERY: Matches 'candidate_Position' string to 'position_Name'
                        String sql = "SELECT c.cand_ID, c.cand_PhotoPath, c.cand_ManifestoDesc, "
                                ...
                                + // This line is the key fix: Join by Name AND Election ID
                        ...
                        // We still sort by p.position_ID so President appears before Treasurer
