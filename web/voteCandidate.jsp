...
<html lang="en">
    <head>
        ...
        <style>
            /* Original Layout and Card Styles Restored */
            .main-content {
    ...
    <body>
                    ...
                    <div class="candidates-grid">
                        ...
                        <div class="candidate-card">
                            <div class="candidate-img-container">
                                <%-- Reconciled Image logic using cand_PhotoPath from database --%>
                                <% if (c.getPhotoPath() != null && !c.getPhotoPath().isEmpty() && !c.getPhotoPath().equals("default_user.png")) {%>
                                <img src="${pageContext.request.contextPath}/images/<%= c.getPhotoPath()%>" alt="Candidate">
                                <% } else { %>
                            ...
                            <div class="candidate-details">
                                ...
                                <%-- Reconciled logic using cand_ManifestoDesc from database --%>
                                <%= (c.getManifesto() != null && !c.getManifesto().isEmpty()) ? c.getManifesto().replace("\n", "<br>") : "<i>No manifesto provided.</i>"%>
                            </div>
                            <button class="btn-vote-candidate" onclick="openVoteModal('<%= c.getCandId()%>', '<%= c.getStudName().replace("'", "\\'")%>')">Vote</button>
                        </div>
                        <% } %>
                    </div>
                </div>
        ...
        <script>
            ...
            // Logout confirmation logic moved to nav inclusion or handled here
