<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@page import="java.text.SimpleDateFormat, java.util.List, com.mvc.bean.ElectionBean, com.mvc.dao.ElectionDao" %>
        <% String userSession=(String) session.getAttribute("userSession"); if (userSession==null) {
            response.sendRedirect("login.jsp"); return; } com.mvc.dao.ElectionDao electionDao=new
            com.mvc.dao.ElectionDao(); List<ElectionBean> electionList = electionDao.getAllElections();
                ...
                <div class="main-content">
                    ...
                    <div class="content-body">
                        ...
                        <div class="elections-grid">
                            ...
                            <% if (electionList !=null && !electionList.isEmpty()) { for (ElectionBean election :
                                electionList) { String startDate=(election.getElectionStartDate() !=null) ?
